 ...
 */var fs=Symbol.for("react.element"),Np=Symbol.for("react.portal"),xp=Symbol.for("react.fragment"),Tp=Symbol.for("react.strict_mode"),Cp=Symbol.for("react.profiler"),_p=Symbol.for("react.provider"),Lp=Symbol.for("react.context"),Op=Symbol.for("react.forward_ref"),$p=Symbol.for("react.suspense"),Ip=Symbol.for("react.memo"),Ap=Symbol.for("react.lazy"),hu=Symbol.iterator;function Pp(e){return e===null||typeof e!="object"?null:(e=hu&&e[hu]||e["@@iterator"],typeof e=="function"?e:null)}var Wc={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Hc=Object.assign,qc={};function lr(e,t,n){this.props=e,this.context=t,this.refs=qc,this.updater=n||Wc}lr.prototype.isReactComponent={};lr.prototype.setState=function(e,t){if(typeof e!="object"&&typeof e!="function"&&e!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,e,t,"setState")};lr.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this,e,"forceUpdate")};function Qc(){}Qc.prototype=lr.prototype;function na(e,t,n){this.props=e,this.context=t,this.refs=qc,this.updater=n||Wc}var ra=na.prototype=new Qc;ra.constructor=na;Hc(ra,lr.prototype);ra.isPureReactComponent=!0;var pu=Array.isArray,Yc=Object.prototype.hasOwnProperty,sa={current:null},Jc={key:!0,ref:!0,__self:!0,__source:!0};function Gc(e,t,n){var r,s={},i=null,l=null;if(t!=null)for(r in t.ref!==void 0&&(l=t.ref),t.key!==void 0&&(i=""+t.key),t)Yc.call(t,r)&&!Jc.hasOwnProperty(r)&&(s[r]=t[r]);var o=arguments.length-2;if(o===1)s.children=n;else if(1<o){for(var a=Array(o),u=0;u<o;u++)a[u]=arguments[u+2];s.children=a}if(e&&e.defaultProps)for(r in o=e.defaultProps,o)s[r]===void 0&&(s[r]=o[r]);return{$$typeof:fs,type:e,key:i,ref:l,props:s,_owner:sa.current}}function jp(e,t){return{$$typeof:fs,type:e.type,key:t,ref:e.ref,props:e.props,_owner:e._owner}}function ia(e){return typeof e=="object"&&e!==null&&e.$$typeof===fs}function Mp(e){var t={"=":"=0",":":"=2"};return"$"+e.replace(/[=:]/g,function(n){return t[n]})}var mu=/\/+/g;function wl(e,t){return typeof e=="object"&&e!==null&&e.key!=null?Mp(""+e.key):t.toString(36)}function Ks(e,t,n,r,s){var i=typeof e;(i==="undefined"||i==="boolean")&&(e=null);var l=!1;if(e===null)l=!0;else switch(i){case"string":case"number":l=!0;break;case"object":switch(e.$$typeof){case fs:case Np:l=!0}}if(l)return l=e,s=s(l),e=r===""?"."+wl(l,0):r,pu(s)?(n="",e!=null&&(n=e.replace(mu,"$&/")+"/"),Ks(s,t,n,"",function(u){return u})):s!=null&&(ia(s)&&(s=jp(s,n+(!s.key||l&&l.key===s.key?"":(""+s.key).replace(mu,"$&/")+"/")+e)),t.push(s)),1;if(l=0,r=r===""?".":r+":",pu(e))for(var o=0;o<e.length;o++){i=e[o];var a=r+wl(i,o);l+=Ks(i,t,n,a,s)}else if(a=Pp(e),typeof a=="function")for(e=a.call(e),o=0;!(i=e.next()).done;)i=i.value,a=r+wl(i,o++),l+=Ks(i,t,n,a,s);else if(i==="object")throw t=String(e),Error("Objects are not valid as a React child (found: "+(t==="[object Object]"?"object with keys {"+Object.keys(e).join(", ")+"}":t)+"). If you meant to render a collection of children, use an array instead.");return l}function Es(e,t,n){if(e==null)return e;var r=[],s=0;return Ks(e,r,"","",function(i){return t.call(n,i,s++)}),r}function Rp(e){if(e._status===-1){var t=e._result;t=t(),t.then(function(n){(e._status===0||e._status===-1)&&(e._status=1,e._result=n)},function(n){(e._status===0||e._status===-1)&&(e._status=2,e._result=n)}),e._status===-1&&(e._status=0,e._result=t)}if(e._status===1)return e._result.default;throw e._result}var xe={current:null},Ws={transition:null},Dp={ReactCurrentDispatcher:xe,ReactCurrentBatchConfig:Ws,ReactCurrentOwner:sa};D.Children={map:Es,forEach:function(e,t,n){Es(e,function(){t.apply(this,arguments)},n)},count:function(e){var t=0;return Es(e,function(){t++}),t},toArray:function(e){return Es(e,function(t){return t})||[]},only:function(e){if(!ia(e))throw Error("React.Children.only expected to receive a single React element child.");return e}};D.Component=lr;D.Fragment=xp;D.Profiler=Cp;D.PureComponent=na;D.StrictMode=Tp;D.Suspense=$p;D.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Dp;D.cloneElement=function(e,t,n){if(e==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+e+".");var r=Hc({},e.props),s=e.key,i=e.ref,l=e._owner;if(t!=null){if(t.ref!==void 0&&(i=t.ref,l=sa.current),t.key!==void 0&&(s=""+t.key),e.type&&e.type.defaultProps)var o=e.type.defaultProps;for(a in t)Yc.call(t,a)&&!Jc.hasOwnProperty(a)&&(r[a]=t[a]===void 0&&o!==void 0?o[a]:t[a])}var a=arguments.length-2;if(a===1)r.children=n;else if(1<a){o=Array(a);for(var u=0;u<a;u++)o[u]=arguments[u+2];r.children=o}return{$$typeof:fs,type:e.type,key:s,ref:i,props:r,_owner:l}};D.createContext=function(e){return e={$$typeof:Lp,_currentValue:e,_currentValue2:e,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},e.Provider={$$typeof:_p,_context:e},e.Consumer=e};D.createElement=Gc;D.createFactory=function(e){var t=Gc.bind(null,e);return t.type=e,t};D.createRef=function(){return{current:null}};D.forwardRef=function(e){return{$$typeof:Op,render:e}};D.isValidElement=ia;D.lazy=function(e){return{$$typeof:Ap,_payload:{_status:-1,_result:e},_init:Rp}};D.memo=function(e,t){return{$$typeof:Ip,type:e,compare:t===void 0?null:t}};D.startTransition=function(e){var t=Ws.transition;Ws.transition={};try{e()}finally{Ws.transition=t}};D.unstable_act=function(){throw Error("act(...) is not supported in production builds of React.")};D.useCallback=function(e,t){return xe.current.useCallback(e,t)};D.useContext=function(e){return xe.current.useContext(e)};D.useDebugValue=function(){};D.useDeferredValue=function(e){return xe.current.useDeferredValue(e)};D.useEffect=function(e,t){return xe.current.useEffect(e,t)};D.useId=function(){return xe.current.useId()};D.useImperativeHandle=function(e,t,n){return xe.current.useImperativeHandle(e,t,n)};D.useInsertionEffect=function(e,t){return xe.current.useInsertionEffect(e,t)};D.useLayoutEffect=function(e,t){return xe.current.useLayoutEffect(e,t)};D.useMemo=function(e,t){return xe.current.useMemo(e,t)};D.useReducer=function(e,t,n){return xe.current.useReducer(e,t,n)};D.useRef=function(e){return xe.current.useRef(e)};D.useState=function(e){return xe.current.useState(e)};D.useSyncExternalStore=function(e,t,n){return xe.current.useSyncExternalStore(e,t,n)};D.useTransition=function(){return xe.current.useTransition()};D.version="18.2.0";Kc.exports=D;var B=Kc.exports;const Un=Ep(B);/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t($,j){var R=$.length;$.push(j);e:for(;0<R;){var Z=R-1>>>1,oe=$[Z];if(0<s(oe,j))$[Z]=j,$[R]=oe,R=Z;else break e}}function n($){return $.length===0?null:$[0]}function r($){if($.length===0)return null;var j=$[0],R=$.pop();if(R!==j){$[0]=R;e:for(var Z=0,oe=$.length,Ss=oe>>>1;Z<Ss;){var Qt=2*(Z+1)-1,vl=$[Qt],Yt=Qt+1,ks=$[Yt];if(0>s(vl,R))Yt<oe&&0>s(ks,vl)?($[Z]=ks,$[Yt]=R,Z=Yt):($[Z]=vl,$[Qt]=R,Z=Qt);else if(Yt<oe&&0>s(ks,R))$[Z]=ks,$[Yt]=R,Z=Yt;else break e}}return j}function s($,j){var R=$.sortIndex-j.sortIndex;return R!==0?R:$.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var l=Date,o=l.now();e.unstable_now=function(){return l.now()-o}}var a=[],u=[],m=1,f=null,p=3,g=!1,w=!1,h=!1,v=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y($){for(var j=n(u);j!==null;){if(j.callback===null)r(u);else if(j.startTime<=$)r(u),j.sortIndex=j.expirationTime,t(a,j);else break;j=n(u)}}function S($){if(h=!1,y($),!w)if(n(a)!==null)w=!0,vr(x);else{var j=n(u);j!==null&&wr(S,j.startTime-$)}}function x($,j){w=!1,h&&(h=!1,d(N),N=-1),g=!0;var R=p;try{for(y(j),f=n(a);f!==null&&(!(f.expirationTime>j)||$&&!M());){var Z=f.callback;if(typeof Z=="function"){f.callback=null,p=f.priorityLevel;var oe=Z(f.expirationTime<=j);j=e.unstable_now(),typeof oe=="function"?f.callback=oe:f===n(a)&&r(a),y(j)}else r(a);f=n(a)}if(f!==null)var Ss=!0;else{var Qt=n(u);Qt!==null&&wr(S,Qt.startTime-j),Ss=!1}return Ss}finally{f=null,p=R,g=!1}}var E=!1,T=null,N=-1,k=5,I=-1;function M(){return!(e.unstable_now()-I<k)}function C(){if(T!==null){var $=e.unstable_now();I=$;var j=!0;try{j=T(!0,$)}finally{j?A():(E=!1,T=null)}}else E=!1}var A;if(typeof c=="function")A=function(){c(C)};else if(typeof MessageChannel<"u"){var pe=new MessageChannel,yr=pe.port2;pe.port1.onmessage=C,A=function(){yr.postMessage(null)}}else A=function(){v(C,0)};function vr($){T=$,E||(E=!0,A())}function wr($,j){N=v(function(){$(e.unstable_now())},j)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function($){$.callback=null},e.unstable_continueExecution=function(){w||g||(w=!0,vr(x))},e.unstable_forceFrameRate=function($){0>$||125<$?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):k=0<$?Math.floor(1e3/$):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function($){switch(p){case 1:case 2:case 3:var j=3;break;default:j=p}var R=p;p=j;try{return $()}finally{p=R}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function($,j){switch($){case 1:case 2:case 3:case 4:case 5:break;default:$=3}var R=p;p=$;try{return j()}finally{p=R}},e.unstable_scheduleCallback=function($,j,R){var Z=e.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?Z+R:Z):R=Z,$){case 1:var oe=-1;break;case 2:oe=250;break;case 5:oe=1073741823;break;case 4:oe=1e4;break;default:oe=5e3}return oe=R+oe,$={id:m++,callback:j,priorityLevel:$,startTime:R,expirationTime:oe,sortIndex:-1},R>Z?($.sortIndex=R,t(u,$),n(a)===null&&$===n(u)&&(h?(d(N),N=-1):h=!0,wr(S,R-Z))):($.sortIndex=oe,t(a,$),w||g||(w=!0,vr(x))),$},e.unstable_shouldYield=M,e.unstable_wrapCallback=function($){var j=p;return function(){var R=p;p=j;try{return $.apply(this,arguments)}finally{p=R}}}})(nf);tf.exports=nf;var Gp=tf.exports;/**
 * @license React
...
`,a+=2;l+=i,n[a+2]===" "&&(l+="\\"),a+=1,o=a+1}break;default:a+=1}return l=o?l+n.slice(o):n,r?l:ll(l,i,ai,ol(t,!1))}function Xo(e,t){if(t.options.singleQuote===!1||t.implicitKey&&e.includes(`
`)||/[ \t]\n|\n[ \t]/.test(e))return Kr(e,t);const n=t.indent||(al(e)?"  ":""),r="'"+e.replace(/'/g,"''").replace(/\n+/g,`$&
${n}`)+"'";return t.implicitKey?r:ll(r,n,Bh,ol(t,!1))}function zn(e,t){const{singleQuote:n}=t.options;let r;if(n===!1)r=Kr;else{const s=e.includes('"'),i=e.includes("'");s&&!i?r=Xo:i&&!s?r=Kr:r=n?Xo:Kr}return r(e,t)}let Zo;try{Zo=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch{Zo=/\n+(?!\n|$)/g}function ui({comment:e,type:t,value:n},r,s,i){const{blockQuote:l,commentString:o,lineWidth:a}=r.options;if(!l||/\n[\t ]+$/.test(n)||/^\s*$/.test(n))return zn(n,r);const u=r.indent||(r.forceBlockIndent||al(n)?"  ":""),m=l==="literal"?!0:l==="folded"||t===P.BLOCK_FOLDED?!1:t===P.BLOCK_LITERAL?!0:!t0(n,a,u.length);if(!n)return m?`|
`:`>
`;let f,p;for(p=n.length;p>0;--p){const E=n[p-1];if(E!==`
`&&E!=="	"&&E!==" ")break}let g=n.substring(p);const w=g.indexOf(`
`);w===-1?f="-":n===g||w!==g.length-1?(f="+",i&&i()):f="",g&&(n=n.slice(0,-g.length),g[g.length-1]===`
`&&(g=g.slice(0,-1)),g=g.replace(Zo,`$&${u}`));let h=!1,v,d=-1;for(v=0;v<n.length;++v){const E=n[v];if(E===" ")h=!0;else if(E===`
...
`+v.comment:o.comment=v.comment);continue}(v.newlineAfterProp||us(g))&&s(g??p[p.length-1],"MULTILINE_IMPLICIT_KEY","Implicit keys need to be on a single line")}else((m=v.found)==null?void 0:m.indent)!==r.indent&&s(a,"BAD_INDENT",bc);n.atKey=!0;const c=v.end,y=g?e(n,g,v,s):t(n,c,p,null,v,s);n.schema.compat&&ea(r.indent,g,s),n.atKey=!1,op(n,o.items,y)&&s(c,"DUPLICATE_KEY","Map keys must be unique");const S=ir(w??[],{indicator:"map-value-ind",next:h,offset:y.range[2],onError:s,parentIndent:r.indent,startOnNewline:!g||g.type==="block-scalar"});if(a=S.end,S.found){d&&((h==null?void 0:h.type)==="block-map"&&!S.hasNewline&&s(a,"BLOCK_AS_IMPLICIT_KEY","Nested mappings are not allowed in compact mappings"),n.options.strict&&v.start<S.found.offset-1024&&s(y.range,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));const x=h?e(n,h,S,s):t(n,a,w,null,S,s);n.schema.compat&&ea(r.indent,h,s),a=x.range[2];const E=new we(y,x);n.options.keepSourceTokens&&(E.srcToken=f),o.items.push(E)}else{d&&s(y.range,"MISSING_CHAR","Implicit map keys need to be followed by map values"),S.comment&&(y.comment?y.comment+=`
`+S.comment:y.comment=S.comment);const x=new we(y);n.options.keepSourceTokens&&(x.srcToken=f),o.items.push(x)}}return u&&u<a&&s(u,"IMPOSSIBLE","Map comment with trailing content"),o.range=[r.offset,a,u??a],o}function T0({composeNode:e,composeEmptyNode:t},n,r,s,i){const l=(i==null?void 0:i.nodeClass)??Kt,o=new l(n.schema);n.atRoot&&(n.atRoot=!1),n.atKey&&(n.atKey=!1);let a=r.offset,u=null;for(const{start:m,value:f}of r.items){const p=ir(m,{indicator:"seq-item-ind",next:f,offset:a,onError:s,parentIndent:r.indent,startOnNewline:!0});if(!p.found)if(p.anchor||p.tag||f)f&&f.type==="block-seq"?s(p.end,"BAD_INDENT","All sequence items must start at the same column"):s(a,"MISSING_CHAR","Sequence item without - indicator");else{u=p.end,p.comment&&(o.comment=p.comment);continue}const g=f?e(n,f,p,s):t(n,p.end,m,null,p,s);n.schema.compat&&ea(r.indent,f,s),a=g.range[2],o.items.push(g)}return o.range=[r.offset,a,u??a],o}function ws(e,t,n,r){let s="";if(e){let i=!1,l="";for(const o of e){const{source:a,type:u}=o;switch(u){case"space":i=!0;break;case"comment":{n&&!i&&r(o,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const m=a.substring(1)||" ";s?s+=l+m:s=m,l="";break}case"newline":s&&(l+=a),i=!0;break;default:r(o,"UNEXPECTED_TOKEN",`Unexpected ${u} at node end`)}t+=a.length}}return{comment:s,offset:t}}const Yl="Block collections are not allowed within flow collections",Jl=e=>e&&(e.type==="block-map"||e.type==="block-seq");function C0({composeNode:e,composeEmptyNode:t},n,r,s,i){const l=r.start.source==="{",o=l?"flow map":"flow sequence",a=(i==null?void 0:i.nodeClass)??(l?Re:Kt),u=new a(n.schema);u.flow=!0;const m=n.atRoot;m&&(n.atRoot=!1),n.atKey&&(n.atKey=!1);let f=r.offset+r.start.source.length;for(let v=0;v<r.items.length;++v){const d=r.items[v],{start:c,key:y,sep:S,value:x}=d,E=ir(c,{flow:o,indicator:"explicit-key-ind",next:y??(S==null?void 0:S[0]),offset:f,onError:s,parentIndent:r.indent,startOnNewline:!1});if(!E.found){if(!E.anchor&&!E.tag&&!S&&!x){v===0&&E.comma?s(E.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${o}`):v<r.items.length-1&&s(E.start,"UNEXPECTED_TOKEN",`Unexpected empty item in ${o}`),E.comment&&(u.comment?u.comment+=`
`+E.comment:u.comment=E.comment),f=E.end;continue}!l&&n.options.strict&&us(y)&&s(y,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line")}if(v===0)E.comma&&s(E.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${o}`);else if(E.comma||s(E.start,"MISSING_CHAR",`Missing , between ${o} items`),E.comment){let T="";e:for(const N of c)switch(N.type){case"comma":case"space":break;case"comment":T=N.source.substring(1);break e;default:break e}if(T){let N=u.items[u.items.length-1];H(N)&&(N=N.value??N.key),N.comment?N.comment+=`
`+T:N.comment=T,E.comment=E.comment.substring(T.length+1)}}if(!l&&!S&&!E.found){const T=x?e(n,x,E,s):t(n,E.end,S,null,E,s);u.items.push(T),f=T.range[2],Jl(x)&&s(T.range,"BLOCK_IN_FLOW",Yl)}else{n.atKey=!0;const T=E.end,N=y?e(n,y,E,s):t(n,T,c,null,E,s);Jl(y)&&s(N.range,"BLOCK_IN_FLOW",Yl),n.atKey=!1;const k=ir(S??[],{flow:o,indicator:"map-value-ind",next:x,offset:N.range[2],onError:s,parentIndent:r.indent,startOnNewline:!1});if(k.found){if(!l&&!E.found&&n.options.strict){if(S)for(const C of S){if(C===k.found)break;if(C.type==="newline"){s(C,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}E.start<k.found.offset-1024&&s(k.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else x&&("source"in x&&x.source&&x.source[0]===":"?s(x,"MISSING_CHAR",`Missing space after : in ${o}`):s(k.start,"MISSING_CHAR",`Missing , or : between ${o} items`));const I=x?e(n,x,k,s):k.found?t(n,k.end,S,null,k,s):null;I?Jl(x)&&s(I.range,"BLOCK_IN_FLOW",Yl):k.comment&&(N.comment?N.comment+=`
`+k.comment:N.comment=k.comment);const M=new we(N,I);if(n.options.keepSourceTokens&&(M.srcToken=d),l){const C=u;op(n,C.items,N)&&s(T,"DUPLICATE_KEY","Map keys must be unique"),C.items.push(M)}else{const C=new Re(n.schema);C.flow=!0,C.items.push(M);const A=(I??N).range;C.range=[N.range[0],A[1],A[2]],u.items.push(C)}f=I?I.range[2]:k.end}}const p=l?"}":"]",[g,...w]=r.end;let h=f;if(g&&g.source===p)h=g.offset+g.source.length;else{const v=o[0].toUpperCase()+o.substring(1),d=m?`${v} must end with a ${p}`:`${v} in block collection must be sufficiently indented and end with a ${p}`;s(f,m?"MISSING_CHAR":"BAD_INDENT",d),g&&g.source.length!==1&&w.unshift(g)}if(w.length>0){const v=ws(w,h,n.options.strict,s);v.comment&&(u.comment?u.comment+=`
`+v.comment:u.comment=v.comment),u.range=[r.offset,h,v.offset]}else u.range=[r.offset,h,h];return u}function Gl(e,t,n,r,s,i){const l=n.type==="block-map"?x0(e,t,n,r,i):n.type==="block-seq"?T0(e,t,n,r,i):C0(e,t,n,r,i),o=l.constructor;return s==="!"||s===o.tagName?(l.tag=o.tagName,l):(s&&(l.tag=s),l)}function _0(e,t,n,r,s){var p;const i=r.tag,l=i?t.directives.tagName(i.source,g=>s(i,"TAG_RESOLVE_FAILED",g)):null;if(n.type==="block-seq"){const{anchor:g,newlineAfterProp:w}=r,h=g&&i?g.offset>i.offset?g:i:g??i;h&&(!w||w.offset<h.offset)&&s(h,"MISSING_CHAR","Missing newline after block sequence props")}const o=n.type==="block-map"?"map":n.type==="block-seq"?"seq":n.start.source==="{"?"map":"seq";if(!i||!l||l==="!"||l===Re.tagName&&o==="map"||l===Kt.tagName&&o==="seq")return Gl(e,t,n,s,l);let a=t.schema.tags.find(g=>g.tag===l&&g.collection===o);if(!a){const g=t.schema.knownTags[l];if(g&&g.collection===o)t.schema.tags.push(Object.assign({},g,{default:!1})),a=g;else return g!=null&&g.collection?s(i,"BAD_COLLECTION_TYPE",`${g.tag} used for ${o} collection, but expects ${g.collection}`,!0):s(i,"TAG_RESOLVE_FAILED",`Unresolved tag: ${l}`,!0),Gl(e,t,n,s,l)}const u=Gl(e,t,n,s,l,a),m=((p=a.resolve)==null?void 0:p.call(a,u,g=>s(i,"TAG_RESOLVE_FAILED",g),t.options))??u,f=J(m)?m:new P(m);return f.range=u.range,f.tag=l,a!=null&&a.format&&(f.format=a.format),f}function ap(e,t,n){const r=t.offset,s=L0(t,e.options.strict,n);if(!s)return{value:"",type:null,comment:"",range:[r,r,r]};const i=s.mode===">"?P.BLOCK_FOLDED:P.BLOCK_LITERAL,l=t.source?O0(t.source):[];let o=l.length;for(let h=l.length-1;h>=0;--h){const v=l[h][1];if(v===""||v==="\r")o=h;else break}if(o===0){const h=s.chomp==="+"&&l.length>0?`
...
`:case"\r":case"	":return!0;default:return!1}}const Fc=new Set("0123456789ABCDEFabcdef"),X0=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Us=new Set(",[]{}"),Z0=new Set(` ,[]{}
\r	`),Zl=e=>!e||Z0.has(e);class yp{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer="",this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(t,n=!1){if(t){if(typeof t!="string")throw TypeError("source is not a string");this.buffer=this.buffer?this.buffer+t:t,this.lineEndPos=null}this.atEnd=!n;let r=this.next??"stream";for(;r&&(n||this.hasChars(1));)r=yield*this.parseNext(r)}atLineEnd(){let t=this.pos,n=this.buffer[t];for(;n===" "||n==="	";)n=this.buffer[++t];return!n||n==="#"||n===`
